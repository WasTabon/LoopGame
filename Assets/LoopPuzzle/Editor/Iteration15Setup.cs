...
public class Iteration15Setup
{
    ...
    [MenuItem("Tools/Loop Puzzle/Setup Iteration 15")]
    public static void Setup()
    {
        ...
        if (failures > 0)
        {
            Debug.LogError($"Iteration 15: {failures} level(s) failed validation. Aborting database rebuild.");
            return;
        }
        ...
        Debug.Log($"Iteration 15 setup complete: {levels.Count} levels imported (incl. color-loop levels 35-37), all validated.");
    }
