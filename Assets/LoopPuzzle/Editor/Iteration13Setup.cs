...
public class Iteration13Setup
{
    ...
    [MenuItem("Tools/Loop Puzzle/Setup Iteration 13")]
    public static void Setup()
    {
        ...
        if (failures > 0)
        {
            Debug.LogError($"Iteration 13: {failures} level(s) failed validation. Aborting database rebuild.");
            return;
        }
        ...
        Debug.Log($"Iteration 13 setup complete: {levels.Count} levels imported (incl. breakable/limit levels 29-31), all validated.");
    }
