...
public class Iteration17Setup
{
    ...
    [MenuItem("Tools/Loop Puzzle/Setup Iteration 17")]
    public static void Setup()
    {
        ...
        if (failures > 0)
        {
            Debug.LogError($"Iteration 17: {failures} level(s) failed validation. Aborting database rebuild.");
            return;
        }
        ...
        Debug.Log($"Iteration 17 setup complete: {levels.Count} levels imported (rebalanced into 7 worlds with combo levels), all validated.");
    }
    ...
    private static LevelData ImportLevel(JsonLevel jl)
    {
        ...
        level.portalsMode = jl.portalsMode;
