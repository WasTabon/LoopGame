...
public class Iteration12Setup
{
    ...
    [MenuItem("Tools/Loop Puzzle/Setup Iteration 12")]
    public static void Setup()
    {
        ...
        if (failures > 0)
        {
            Debug.LogError($"Iteration 12: {failures} level(s) failed validation. Aborting database rebuild.");
            return;
        }
        ...
        Debug.Log($"Iteration 12 setup complete: {levels.Count} levels imported (incl. bridge levels 26-28), all validated.");
    }
