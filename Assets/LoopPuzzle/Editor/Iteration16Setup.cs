...
public class Iteration16Setup
{
    ...
    [MenuItem("Tools/Loop Puzzle/Setup Iteration 16")]
    public static void Setup()
    {
        ...
        if (failures > 0)
        {
            Debug.LogError($"Iteration 16: {failures} level(s) failed validation. Aborting database rebuild.");
            return;
        }
        ...
        Debug.Log($"Iteration 16 setup complete: {levels.Count} levels imported (incl. portal levels 38-40), all validated.");
    }
